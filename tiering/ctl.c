 ...
 * into single queries
 */
static int ctl_parse_query(char *qbuf, tier_draft *tier)
{
    char *sptr = NULL;
 ...
 */
static int ctl_load_config(char *buf, tier_draft *tier,
...
static memkind_t ctl_get_kind(const tier_draft *tier)
{
    memkind_t kind = NULL;
