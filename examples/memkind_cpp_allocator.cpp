...
int main(int argc, char *argv[])
{
...
#ifdef STL_FWLIST_TEST
    {
        ...
        try {
            libmemkind::static_kind::allocator<int> alc{
                libmemkind::kinds::REGULAR};
            std::forward_list<int, libmemkind::static_kind::allocator<int>>
                fwlist{alc};
            int i;
            ...
            std::cout
                << "Something has gone wrong. This is most likely a memory allocation failure (e.g. It runs out of memory): "
                << e.what() << std::endl;
        }
    ...
    try {
        libmemkind::static_kind::allocator<int> int_alc{
            libmemkind::kinds::REGULAR};
