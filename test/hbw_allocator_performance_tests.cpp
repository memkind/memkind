...
class HbwAllocatorPerformanceTest: public ::testing::Test
{
private:
...
TEST_F(HbwAllocatorPerformanceTest,
...
{
    run_test(AllocatorTypes::HBWMALLOC_ALLOCATOR, FunctionCalls::MALLOC, 1,
             4096, 10000);
}
...
{
    run_test(AllocatorTypes::HBWMALLOC_ALLOCATOR, FunctionCalls::CALLOC, 1,
             4096, 10000);
}
