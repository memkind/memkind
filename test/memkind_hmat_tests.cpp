...
TEST_F(MemkindHMATFunctionalTests,
...
TEST_F(MemkindHMATFunctionalTests, test_TC_HMAT_HC_correct_numa)
{
...
TEST_F(MemkindHMATFunctionalTests, test_TC_HMAT_HC_alloc_until_full_numa)
{
    memkind_t kind = MEMKIND_HIGHEST_CAPACITY;
