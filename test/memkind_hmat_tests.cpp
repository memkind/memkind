...
// NOTE: this is hardcoded and should match topologies in utils/qemu/topology
// This map shows what are EXPECTED NUMA nodes for HIGHEST_CAPACITY_LOCAL
...
{
    memkind_t kind = MEMKIND_HIGHEST_CAPACITY_LOCAL;
    int size = 10;
...
TEST_P(MemkindHMATFunctionalTests,
       test_TC_HiCapacityLocal_alloc_until_full_numa)
{
    memkind_t kind = MEMKIND_HIGHEST_CAPACITY_LOCAL;
