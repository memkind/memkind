...
TEST_F(MemkindMemtierTest, test_tier_policy_dynamic_threshold_ctl_set_only_first)
{
    size_t val = 8000;
    int res = memtier_ctl_set(m_builder,
                          "policy.dynamic_threshold.thresholds[0].val", &val);
    ASSERT_EQ(0, res);
...
TEST_F(MemkindMemtierTest, test_tier_policy_dynamic_threshold_ctl_set_only_last)
{
    size_t val = 8000;
    int res = memtier_ctl_set(m_builder,
                          "policy.dynamic_threshold.thresholds[1].val", &val);
