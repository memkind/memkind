...
MEMKIND_EXPORT void ranking_pop_coldest(ranking_handle handle,
                                        PageMetadata *page)
{
    *page = static_cast<Ranking *>(handle)->PopColdest();
}
MEMKIND_EXPORT void ranking_pop_hottest(ranking_handle handle,
                                        PageMetadata *page)
{
    *page = static_cast<Ranking *>(handle)->PopHottest();
}
MEMKIND_EXPORT void ranking_add_page(ranking_handle handle, PageMetadata *page)
{
    static_cast<Ranking *>(handle)->AddPage(*page);
}
