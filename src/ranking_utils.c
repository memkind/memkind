...
MEMKIND_EXPORT int move_page_metadata(uintptr_t page_metadata_addr,
                                      memory_type_t memory_type)
{
    ...
    void *os_page_addr = (void *)(page_metadata_addr & page_mask);
    ...
    switch (memory_type) {
        case DRAM:
            ...
            ret =
                mbind(os_page_addr, TRACED_PAGESIZE, MPOL_BIND, dram_nodemask.n,
        ...
        case DAX_KMEM:
            ...
            ret = mbind(os_page_addr, TRACED_PAGESIZE, MPOL_BIND,
