...
struct heap_manager_ops {
    ...
    int (*heap_manager_set_background_threads)(bool enable);
};
...
static struct heap_manager_ops arena_heap_manager_g = {
    ...
    .heap_manager_set_background_threads = memkind_arena_set_background_threads
};
...
static struct heap_manager_ops tbb_heap_manager_g = {
    ...
    .heap_manager_set_background_threads = tbb_set_background_threads
};
...
int heap_manager_set_background_threads(bool enable)
{
    return get_heap_manager()->heap_manager_set_background_threads(enable);
}
