...
struct heap_manager_ops {
    ...
    int (*heap_manager_set_bg_threads)(int *get_state, size_t get_size, int *set_state, size_t set_size);
};
...
int heap_manager_set_bg_threads(int *read_state, size_t read_sz, int *enable, size_t sz)
{
