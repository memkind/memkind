...
#define m_set_bg_threads(enable)       heap_manager_set_bg_threads(enable)
#else
...
#define m_set_bg_threads(enable)       memkind_arena_set_bg_threads(enable)
#endif
...
MEMKIND_EXPORT int memkind_set_bg_threads(int *enable)
{
