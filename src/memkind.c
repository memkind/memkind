...
#define m_stats_print(write_cb, cbopaque)                  heap_manager_stats_print(write_cb, cbopaque)
...
#define m_stats_print(write_cb, cbopaque)                  memkind_arena_stats_print(write_cb, cbopaque)
...
{
    return m_stats_print(write_cb, cbopaque);
}
