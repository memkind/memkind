...
static struct memkind MEMKIND_LOCAL_HIGHEST_CAPACITY_STATIC = {
    .ops = &MEMKIND_LOCAL_HIGHEST_CAPACITY_OPS,
    .partition = MEMKIND_PARTITION_LOCAL_HIGHEST_CAPACITY,
    .name = "memkind_local_highest_capacity",
    .init_once = PTHREAD_ONCE_INIT,
};
...
MEMKIND_EXPORT struct memkind *MEMKIND_LOCAL_HIGHEST_CAPACITY =
        &MEMKIND_LOCAL_HIGHEST_CAPACITY_STATIC;
...
static struct memkind_registry memkind_registry_g = {
    {
        ...
        [MEMKIND_PARTITION_LOCAL_HIGHEST_CAPACITY] = &MEMKIND_LOCAL_HIGHEST_CAPACITY_STATIC,
    },
