...
int critnib_create(critnib *c) __nonnull((1));
void critnib_destroy(critnib *c) __nonnull((1));

int critnib_insert(critnib *c, uintptr_t key, void *value, int update)
    __nonnull((1));
void *critnib_remove(critnib *c, uintptr_t key) __nonnull((1));
void *critnib_get(critnib *c, uintptr_t key) __nonnull((1));
void *critnib_find_le(critnib *c, uintptr_t key) __nonnull((1));
int critnib_find(critnib *c, uintptr_t key, enum find_dir_t dir,
                 uintptr_t *rkey, void **rvalue) __nonnull((1));
void critnib_iter(critnib *c, uintptr_t min, uintptr_t max,
                  int (*func)(uintptr_t key, void *value, void *privdata),
                  void *privdata) __nonnull((1));
