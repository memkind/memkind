...
%changelog
* Thu Jan 22 2015 Christopher Cantalupo <christopher.m.cantalupo@intel.com> 3.5.1+mk3
  - Moved to a single memkind callback: memkind_partition_mmap().
  - Backported patch 20a8c78bfe3310e0f0f72b596d4e10ca7336063b from upstream jemalloc.
